...
#            bsub -q 8nh -M 2000 -J SingleEbl < submitJob.sh

export X509_USER_PROXY=/afs/cern.ch/user/j/jruizvar/x509up_u9472
cd /afs/cern.ch/work/j/jruizvar/private/Run2/TnP/CMSSW_7_4_14/src/PhysicsTools/TagAndProbe/test/forVZ
eval `scramv1 runtime -sh`

cmsRun tnp_HEEP_MiniIso.py SingleElectron_Run2015D-bl
