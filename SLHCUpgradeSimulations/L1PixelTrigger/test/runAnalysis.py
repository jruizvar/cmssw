...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        #'/store/group/comm_trigger/L1TrackTrigger/preBuild_620_SLHC9/Extended2023TTI/Electrons/NoPU/SingleElectrons_DIGI_1.root'
        '/store/group/comm_trigger/L1TrackTrigger/preBuild_620_SLHC9/Extended2023TTI/Electrons/PU140/SingleElectron_E2023TTI_PU140_1.root'
    )
)
